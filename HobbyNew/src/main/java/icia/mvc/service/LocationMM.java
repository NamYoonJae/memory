		    ...
		    // tag.append("       content: '내 위치'\n");
		     ...
		     // tag.append("  infowindow.open(map, marker);\n");
		      ...
		      for(int i=0; i<locList.size(); i++) {
		         ...
		         // tag.append(" var content = "+ content+";");
		         //  tag.append(" var aa = '"+ content+"';");
		         
		         /*
		         tag.append(" var aa = '<div class='wrap'>' + \n");
		         tag.append("        '    <div class='info'>' + \n");
		         tag.append("       '        <div class='title'>' + \n");
		         tag.append("   '            카카오 스페이스닷원' + \n");
		         tag.append("    '            <div class='close' onclick='closeOverlay()' title='닫기'></div>' + \n");
		         tag.append("   '        </div>' + \n");
		         tag.append("   '        <div class='body'>' + \n");
		         tag.append("   '            <div class='img'>' +\n");
		         tag.append("   '                <img src='http://cfile181.uf.daum.net/image/250649365602043421936D' width='73' height='70'>' +\n");
		         tag.append("   '           </div>' + \n");
		         tag.append("    '            <div class='desc'>' + \n");
		         tag.append("    '                <div class='ellipsis'>제주특별자치도 제주시 첨단로 242</div>' + \n");
		         tag.append("    '                <div class='jibun ellipsis'>(우) 63309 (지번) 영평동 2181</div>' + \n");
		         tag.append("  '                <div><a href='http://www.kakaocorp.com/main' target='_blank' class='link'>홈페이지</a></div>' +\n"); 
		         tag.append("'            </div>' + \n");
		         tag.append("'        </div>' + \n");
		         tag.append("            '    </div>' +    \n");
		         tag.append(" '</div>';\n");		          
		      */
		      ...
		      // String sss = "<div onclick='asd(this)'></div>";
