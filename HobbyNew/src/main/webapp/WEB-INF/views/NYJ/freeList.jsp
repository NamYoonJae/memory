...
<html>
	...
	<body>
		...
		<form id="searchForm" name="searchForm" action="freeSearch" method="POST">
		<select class="lefts" id="boardSearch" name="boardSearch">
			<option value="-1">전체</option>
			<option value="0">글 제목</option>
			<option value="1">글 내용</option>
		</select>
	
		<!-- <select class="lefts" id="sortSearch" name="sortSearch">
			<option value="-1">전체</option>
		...
		<input type="submit" class="leftss" value="검색">
		<br/><br/>
		</form>
		
		<!-- ============================================ -->
		<div id="freeListTableDiv">
			<c:if test="${flist[0]==null}">
				<div id="resultZero"><p>검색 결과가 없습니다</p></div>
			</c:if>
